...
export function Wristband({
  ...
  return (
    ...
    <Link href={url} className="">
        ...
        ">
            <Image className="" src="/assets/images/squiggle.svg" alt="Squiggle on the wristband." width={16} height={40}></Image>
            <Image className="" src="/assets/images/squiggle.svg" alt="Squiggle on the wristband." width={16} height={40}></Image>
            <Image className="" src="/assets/images/squiggle.svg" alt="Squiggle on the wristband." width={16} height={40}></Image>
            <Image className="" src="/assets/images/squiggle.svg" alt="Squiggle on the wristband." width={16} height={40}></Image>
        </div>

        <div className="flex-1 p-4 group-hover:underline text-sm md:text-xl">
          {city} - {venueName}
        </div>
        ...
        ">
            <Image className="opacity-[.40]" src="/assets/images/arrow.svg" alt="Arrow on the wristband." width={30} height={10}></Image>
            <Image className="opacity-[.40]" src="/assets/images/arrow.svg" alt="Arrow on the wristband." width={30} height={10}></Image>
            <Image className="opacity-[.40]" src="/assets/images/arrow.svg" alt="Arrow on the wristband." width={30} height={10}></Image>
            <Image className="opacity-[.40]" src="/assets/images/arrow.svg" alt="Arrow on the wristband." width={30} height={10}></Image>
        </div>
